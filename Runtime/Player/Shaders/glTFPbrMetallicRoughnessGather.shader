Shader "Custom/glTFPbrMetallicRoughnessGather"
{
    Properties
    {
        baseColorFactor("Base Color", Color) = (1,1,1,1)
        [MainTexture] _MainTex("Base Color Tex", 2D) = "white" {}
        ...
        metallicFactor ("Metallic", Range(0,1)) = 1.0
        roughnessFactor ("Roughness", Range(0,1)) = 1.0
